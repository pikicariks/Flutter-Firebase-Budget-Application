          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  IconButton(onPressed: () async => await launchUrl(Uri.parse("https://instagram.com/tomcruise")), icon: SvgPicture.asset("assets/instagram.svg", color: Colors.black,width: 35.0,))
                ],
              )
            ],
          ),
        ...
        body: ListView(
          children: [
                ...
                Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      RotatedBox(quarterTurns: 1, child: Divider(indent:  40.0,endIndent: 40.0,color: Colors.grey,)),
                      Column(
                        mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
            ...
            Row(
              mainAxisAlignment: MainAxisAlignment.spaceEvenly,
              children: [
                SizedBox(height: 40.0,width: 155.0,
                ...
                child: MaterialButton(
                  child: Row(
                    ...
                    children: [
                      Icon(Icons.add, color: Colors.white, size: 15.0,),
                      OpenSans(text: "Add Income", size: 14.0, color: Colors.white,)
                    ],
                  ),
                  splashColor: Colors.grey,
                  color: Colors.black,
                    ...
                    Container(
                      ...
                      itemBuilder: (BuildContext context, int index) {
                        return Row(
                          mainAxisAlignment: MainAxisAlignment.spaceBetween,
                          children: [
                            Poppins(text: viewModelProvider.expensesName[index], size: 12.0),
                            Align(
                ...
                Column(
                  children: [
                    ...
                    Container(
                      ...
                      child: ListView.builder(itemCount: viewModelProvider.incomesAmount.length,
                      itemBuilder: (BuildContext context, int index) {
                        return Row(
                          mainAxisAlignment: MainAxisAlignment.spaceBetween,
                          children: [
                            Poppins(text: viewModelProvider.incomesName[index], size: 12.0),
                            Align(
                              alignment: Alignment.centerRight,
                              child: Poppins(
